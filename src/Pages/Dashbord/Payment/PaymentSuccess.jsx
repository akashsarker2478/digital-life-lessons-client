...
const PaymentSuccess = () => {
    ...
    useEffect(() => {
        console.log("Payment successful, synchronizing user status with DB...");
        ...
        <div className="flex items-center justify-center min-h-[70vh] bg-gray-50 px-4">
            <div className="bg-white p-10 rounded-2xl shadow-xl text-center max-w-md">
                ...
                <p className="text-gray-600 mb-6">
                    Thank you! Your **Lifetime Premium Access** is now activating.
                    <br/>
                    **We are synchronizing your account and redirecting you shortly...**
                </p>
