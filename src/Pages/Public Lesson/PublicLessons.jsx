    ...
    return (
      <div className="flex justify-center items-center gap-3 mt-16">
        <button
          ...
          className="px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed font-medium transition"
        >
          Previous
        </button>
      ...
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              />
            </div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            >
        ...
        {lessons.length === 0 ? (
          <div className="text-center py-20">
            <FaGlobe className="w-20 h-20 text-gray-300 dark:text-gray-500 mx-auto mb-4" />
            <p className="text-2xl text-gray-500 dark:text-gray-400">No lessons found</p>
            <p className="text-gray-400 dark:text-gray-500 mt-2">Try adjusting your filters or search term</p>
          </div>
        ) : (
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {lessons.map((lesson, index) => {
                ...
                return (
                  <div
                    key={lesson._id}
                    className={`relative rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-700 group ${!isLocked ? 'cursor-pointer' : ''}`}
                  ...
                  >
                    ...
                    <div className={`p-6 ${isLocked ? "opacity-60" : ""}`}>
                      <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-3 line-clamp-2">
                        {lesson.title}
                      </h3>
                      <p className="text-gray-600 dark:text-gray-400 mb-4 line-clamp-3">{lesson.description}</p>
                      ...
                      <div className="flex flex-wrap gap-3 mb-5">
                        ...
                        <span className="px-4 py-1.5 bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 rounded-full text-sm font-medium">
                          {lesson.tone || "Neutral"}
                        </span>
                        <span className={`px-4 py-1.5 rounded-full text-sm font-medium flex items-center gap-1.5 ${
                          lesson.accessLevel === "premium" ? "bg-orange-100 dark:bg-orange-900/50 text-orange-700 dark:text-orange-300" : "bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300"
                        }`}>
                      ...
                      <div className="flex items-center gap-4 mb-6">
                        <div className="w-14 h-14 rounded-full overflow-hidden border-3 border-white dark:border-gray-800 shadow">
                          {lesson.creatorPhoto ? (
                        ...
                        <div>
                          <p className="font-bold text-gray-800 dark:text-gray-100">{lesson.creatorName}</p>
