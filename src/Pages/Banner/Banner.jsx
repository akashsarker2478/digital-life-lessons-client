  ...
  const slides = [
    {
      ...
      subtext:
        "Reflect on your experiences and transform them into valuable life lessons worth remembering and sharing.",
    ...
    },
    {
      ...
      subtext:
        "Learn from authentic stories, connect with real experiences, and grow collectively with our community of lifelong learners.",
    ...
    },
    {
      ...
      subtext:
        "Every lesson learned is a step forward. Document, share, and master life's wisdom to become your best self.",
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="container mx-auto px-4 md:px-8 lg:px-12">
                  <div className="max-w-2xl ml-0 lg:ml-12 xl:ml-20">
                    ...
                    {/* type animation */}
                    <div
                      className={`mb-6 pl-4 border-l-4 ${slide.accentColor} py-2`}
                    >
                      <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                        <TypeAnimation
                          key={activeIndex}
                          sequence={[slide.headline, 2000]}
                          speed={50}
                          wrapper="span"
                          cursor={false}
                        />
